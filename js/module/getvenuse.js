// let allVenues = [];
// let currentPage = 1;
// const pageSize = 12; // Show 12 venues per page
...
//     const venues = allVenues.slice(start, end);

//     venues.forEach(v => {

//         const imageUrl =
//             v.thumbnail && v.thumbnail !== "" && v.thumbnail !== null
//                 ? IMAGE + v.thumbnail.replace("/var/www/backend/", "")
//                 : "../logo/book.png"; // fallback

//         const rating = v.rating && v.rating > 0 ? v.rating : "No rating";

//         const wishlist = getWishlist();
//         const isLiked = wishlist.includes(v._id);

//         const card = document.createElement("div");
//         card.classList.add("product-item", "col-md-6", "col-lg-3");

//         card.innerHTML = `
//         <a class="btn-wishlist ${isLiked ? 'heart-active' : ''}" data-id="${v._id}">
...
//         <div class="mt-2">
//             <a href="venue-details.html?id=${v._id}" class="nav-link">View Details</a>
//         </div>
//         `;
...
//     // ❤️ BIND HEART CLICK AFTER CARD RENDER
//     bindWishlistClicks();
...
// // BIND HEART BUTTON CLICK EVENTS
